...
sleep 3s
xterm -geometry 80x5+0+0 -e "/opt/ros/kinetic/bin/roslaunch realsense2_camera"
sleep 3s
xterm -geometry 80x5+600+0 -e "/opt/ros/kinetic/bin/roslaunch turtlebot_navigation amcl_demo.launch map_file:=/home/athome/maps/sisoujyou.yaml" &
sleep 3s
